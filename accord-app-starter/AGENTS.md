...
2. Read `/docs/Sprint.md` to understand the current goal, phase, and explicit exclusions.
3. Read `/docs/ProductBacklog.md` to understand priority and scope.
4. Read `/docs/CODEX_ROLE.md` for role expectations.
5. Read the relevant domain documents before touching that domain:
...
6. Inspect the current implementation and working tree before changing anything. Preserve unrelated work.
