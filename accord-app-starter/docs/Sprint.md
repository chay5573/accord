...
- [x] Focused Review & Send redesign: multiple representative review packages, exact-paperwork field records, Needs Review first, Full Paperwork Review in document order, itemized addendum wording, complete transcript/source links, mock paperwork preview, and signature send blocked by unresolved required items.
